...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SZSTWST_MobileApp.Adapters.AssignmentListAdapter, SZSTWST_MobileApp", AssignmentListAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == AssignmentListAdapter.class) {
			mono.android.TypeManager.Activate ("SZSTWST_MobileApp.Adapters.AssignmentListAdapter, SZSTWST_MobileApp", "", this, new java.lang.Object[] {  });
		}
	}

...
public class AssignmentDetailAssetListAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SZSTWST_MobileApp.Adapters.AssignmentDetailAssetListAdapter, SZSTWST_MobileApp", AssignmentDetailAssetListAdapter.class, __md_methods);
	}


	public AssignmentDetailAssetListAdapter ()
	{
		super ();
		if (getClass () == AssignmentDetailAssetListAdapter.class) {
			mono.android.TypeManager.Activate ("SZSTWST_MobileApp.Adapters.AssignmentDetailAssetListAdapter, SZSTWST_MobileApp", "", this, new java.lang.Object[] {  });
		}
	}

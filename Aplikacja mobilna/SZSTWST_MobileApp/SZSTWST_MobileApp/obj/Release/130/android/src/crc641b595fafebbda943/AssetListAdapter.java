...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SZSTWST_MobileApp.Adapters.AssetListAdapter, SZSTWST_MobileApp", AssetListAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == AssetListAdapter.class) {
			mono.android.TypeManager.Activate ("SZSTWST_MobileApp.Adapters.AssetListAdapter, SZSTWST_MobileApp", "", this, new java.lang.Object[] {  });
		}
	}

...
public class NewAssignmentAssetListAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SZSTWST_MobileApp.Adapters.NewAssignmentAssetListAdapter, SZSTWST_MobileApp", NewAssignmentAssetListAdapter.class, __md_methods);
	}


	public NewAssignmentAssetListAdapter ()
	{
		super ();
		if (getClass () == NewAssignmentAssetListAdapter.class) {
			mono.android.TypeManager.Activate ("SZSTWST_MobileApp.Adapters.NewAssignmentAssetListAdapter, SZSTWST_MobileApp", "", this, new java.lang.Object[] {  });
		}
	}
